...
export default function SmartEditor() {
  ...
  return (
    <div className="container flex flex-col space-y-4 max-w-3xl">
      ...
      <motion.button
        whileTap={{ scale: 0.95 }}
        className="bg-primary text-background px-4 py-2 rounded-full shadow hover:shadow-lg transition w-full md:w-auto"
        onClick={handle}
      ...
      {result && (
        ...
        >
          <button
            ...
            className="ml-auto block bg-primary text-background px-2 py-1 rounded w-full md:w-auto"
          >
            نسخ النتيجة
          </button>
          <CodeMirror
